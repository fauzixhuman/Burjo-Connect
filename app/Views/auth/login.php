    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-24 h-24 mb-4">
                <img src="<?= base_url('images/favicon.png') ?>" alt="Logo" class="w-full h-full object-contain">
            </div>
            <h1 class="text-2xl font-bold text-gray-900">Burjo Connect</h1>
        ...
        <p class="text-center text-xs text-gray-400 mt-8">
            &copy; <?= date('Y') ?> Burjo Connect. All rights reserved.
        </p>
    </div>
